        ...
        <div>
            <footer className="footer p-10 bg-base-200 text-base-content">
                <nav>
                    ...
                    <a className="link link-hover">Buy token</a>
                    <a className="link link-hover">Referral</a>
                    <a className="link link-hover">Whitelist</a>
                </nav>
                <nav>
                    ...
                    <a className="link link-hover">Subscribe to our NewsLetter</a>
                </nav>
                <nav>
