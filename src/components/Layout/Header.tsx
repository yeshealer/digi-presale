        ...
        <main className='z-10 absolute w-full px-4 lg:px-12 2xl:px-20 py-5'>
            <div className='flex items-center justify-between'>
                ...
                <div className='flex items-center gap-2 sm:gap-4 lg:gap-6 text-lg'>
                    <div className='cursor-pointer underline-effect text-purple-200 hidden md:inline-block'>Buy token</div>
                    <div className='cursor-pointer underline-effect text-purple-200 hidden md:inline-block'>Whitelist</div>
                    <div className='cursor-pointer underline-effect text-purple-200 hidden md:inline-block'>Referral</div>
                    <div className="dropdown dropdown-end">
                        <label tabIndex={0} className="btn btn-ghost btn-circle avatar">
                            <ThreedotsIcon />
                        </label>
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                            <li><a className='text-lg block md:hidden'>Buy token</a></li>
                            <li className='block lg:hidden'><a className='text-lg'>Whitepaper</a></li>
                            <li><a className='text-lg'>About</a></li>
                            <li><a className='text-lg block md:hidden'>Whitelist</a></li>
                            <li><a className='text-lg block md:hidden'>Referral</a></li>
                            <li><a className='text-lg'>Features</a></li>
